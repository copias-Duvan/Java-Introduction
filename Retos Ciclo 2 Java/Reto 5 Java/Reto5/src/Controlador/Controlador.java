...
public class Controlador {
    ...
    public void agregar(String nombre, int id, String municipio, float irca, String TipoDeAgua, String TipoCuerpoAgua) throws SQLException{
       //Construir Query de Agregar con Insert INTO
       String Query_Agregar = "INSERT INTO CuerpoDeAgua(id,nombre,municipio,TipoCuerpoAgua,TipoAgua,Irca) VALUES("+id+",'"+nombre+"','"+municipio+"','"+TipoCuerpoAgua+"','"+TipoDeAgua+"',"+irca+");";       
    ...
    public void LlenarArray() throws SQLException{
       ...
       ResultSet Resultado = BaseDeDatos.consultar(Query_Consultar); 
       while(Resultado.next()){
        CuerpoDeAgua cuerpoagua = new CuerpoDeAgua(Resultado.getString("nombre"),Integer.parseInt(Resultado.getString("id")),Resultado.getString("municipio"),Resultado.getString("TipoAgua"),Resultado.getString("TipoCuerpoAgua"),Float.parseFloat(Resultado.getString("Irca")));
